...
function includeFile(path, options) {
  ...
  if(path.substr(0,1) === "/" && opts.root){
    opts.filename = exports.resolveInclude(path.replace(/^\/*/,""), opts.root, 1);
  }else{
...
function includeSource(path, options) {
  ...
  if(path.substr(0,1) === "/" && opts.root){
    includePath = exports.resolveInclude(path.replace(/^\/*/,""), opts.root, 1);
  }else{
...
exports.renderFile = function () {
  ...
  if (arguments.length == 3) {
    ...
    if (data && data.settings && type(data.settings.views) == "string") {
